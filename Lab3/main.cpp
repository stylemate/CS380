...
GLuint lightLocGround2, lightLocObject2;
...
glm::mat4 objectRBT2 = glm::scale(7.0f, 7.0f, 7.0f) * glm::rotate(glm::mat4(1.0f), 10.0f, glm::vec3(1.0f, 0.0f, 0.0f)) * glm::translate(0.3f,0.0f,0.0f);
...
int main(void)
{
	...
	do {
		...
		lightLocGround2 = glGetUniformLocation(object2.GLSLProgramID, "uLight");
		glUniform3f(lightLocGround2, lightVec.x, lightVec.y, lightVec.z);
